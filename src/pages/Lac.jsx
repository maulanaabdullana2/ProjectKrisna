...
import Education from '@assets/curriculumLAC.png';
            ...
            >
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-10 md:gap-20 py-10">
                    <div className="flex-shrink-0 w-72 md:w-[320px]">
                        <img alt="Curriculum diagram" className="w-[800px] h-[400px]" src={Education} />
                    </div>
                    <div className="max-w-xl text-left">
                        ...
                        <h3 className="text-[#0066b3] font-bold text-base md:text-lg mb-4">INTERNATIONAL BACCALAUREATE PRIMARY YEARS PROGRAMME</h3>
                        <ul className="list-disc list-inside text-[#0066b3] text-sm md:text-base space-y-1">
                            <li>KNOWLEDGE (Content in math, language, social studies, science and the arts.)</li>
                            <li>CONCEPTS (Important ideas that have universal significance regardless of time or place within and across disciplines. Concepts are presented in the forms of questions that drive the inquiry.)</li>
                            <li>SKILLS (Specific capabilities in thinking, social interactions, self management, and research.)</li>
                            <li>ATTITUDES (Dispositions, values, beliefs, and feelings towards learning.)</li>
